<div class="container h-full mx-auto flex justify-center items-center">
	<div class="space-y-10 text-center flex flex-col items-center">
		<h2 class="h2">Welcome to QuickShot</h2>
		<!-- Animated Logo -->
		<figure>
			...
			<svg
				...
				viewBox="0 0 200 200"
			>
				<image href="https://upload.wikimedia.org/wikipedia/commons/4/4a/White_camera_icon.svg" x="0" y="0" height="200" width="200"/>
		...
		<!-- / -->
		<div class="flex justify-center space-x-2" style="display: flex; flex-direction: column	">
			If you already have an account with us:
			<a
				class="btn variant-filled m-4"
				href="/login"
				rel="noreferrer"
			>
				Login
